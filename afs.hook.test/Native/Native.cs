...
namespace Afs.Hook.Test.Native
{
    public class Native
    {
        ...
        [Reloaded.Hooks.Definitions.X64.Function(Reloaded.Hooks.Definitions.X64.CallingConventions.Microsoft)]
        [Reloaded.Hooks.Definitions.X86.Function(Reloaded.Hooks.Definitions.X86.CallingConventions.Stdcall)]
        public delegate int NtReadFile(out IntPtr handle, FileAccess access, ref OBJECT_ATTRIBUTES objectAttributes, out IO_STATUS_BLOCK ioStatus, FileShare share, uint openOptions);
